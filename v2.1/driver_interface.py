...
class BusWidget(QWidget):
    def __init__(self):
        ...
        self.s = server.SQL()
        self.b = bus_api.API(bus_id, bus_No)
        self.l = line_api.API(bus_id)
    ...
    def initUI(self):
        ...
        self.lb_station.setStyleSheet("color: #004195;"
                         "font: 36pt;"
                         "font: bold;"
                         "border-style: solid;"
                         "border-width: 10px;"
        ...
        self.bus_time.setInterval(2000)
    ...
    def ref_bus(self):
        ...
        if len(self.b.target) > 0:
            ...
            if not int(self.fall_sig):
                self.lb_station.setText('현재: '+self.l.getstationNm(int(self.b.target['sectOrd'].values[0])))
    ...
    def refresh(self):
        ...
        if int(self.fall_sig):
            ...
            if (int(self.fall_sig) == int(self.l.Nmtostation(int(self.b.target['sectOrd'].values[0])))) and int(self.b.target['stopFlag']):
