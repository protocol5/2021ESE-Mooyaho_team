...
class QtGUI(QWidget):
    ...
    def Refresh(self):
        ...
        for i in range(num_of_bus):
            ...
            if FLAGS[i] == 2 :
                # busbtnui
                self.but_list[i].setStyleSheet("background-image : url(./ill_files/pop_button.png); "
            ...
            # 버튼이 눌려있을 때
                ...
                self.but_list[i].setStyleSheet("background-image : url(./ill_files/push_button.png); "
                                            "background-color : white;"
                                            "color: black;"
                                            "font-size:40pt; "
                                            "font : bold ;"
                ...
                self.but_list[i].setStyleSheet("background-image : url(./ill_files/end_bus.png); "
                                            "background-color : white;"
                                            "Text-align:center;" 
                                            "color: white;"
                                            "font-size:35pt; "
    ...
    def make_bus_button(self, bus_number, i):
        ...
        # busbtnui
        button.setStyleSheet("background-image : url(./ill_files/pop_button.png); "
                                            "background-color : white;"
                                            "color: white;"
                                            "font: bold Roman ;"
                                            "font-size:44pt; "
        ...
        if button.text() == '':
            ...
            # busbtnui
            button.setStyleSheet("background-image : url(./ill_files/end_bus.png); "
                                            "background-color : white;"
                                            "color: black;"
                                            "font-size:40pt; "
                                            "font : Roman  ;"
    ...
    def make_bus_stop_button(self,i):
        ...
        button.setStyleSheet("Text-align:center;"
                                "background-image : url(./ill_files/bus_stop_list.png);"
                                # "background-color : white;"
                                "font-size:28pt;" 
                                "font : Roman;"
                                "border-radius: 15px; "
