...
class ClientSocket:
    ...
    def __init__(self, parent):        
        ...
        self.pics = Signal()
        self.pics.recv_signal.connect(self.parent.updatePic)
        self.disconn = Signal()        
    ...
    def receive(self, client):
        while self.bConnect:            
            try:
                ...
                if '.jpg' in msg:
                    nowdir = os.getcwd() + "\\PyQt\\Client\\" + msg
                    print(nowdir)
                    with open(nowdir, 'wb') as f:
                        try:
                            ...
                            print(ex)
                    print("file %s receive clear" % msg)
                    self.pics.recv_signal.emit(nowdir)
                    print('[RECV]:', msg)
                elif msg:
